...
public class Stopwatch { 
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Enter a number till which you want to calc sum of square roots");
        int n = keys.nextInt();
        ...
        System.out.println("\n Math.pow");
        System.out.println("%e Sum: " + sum2 );
        System.out.println("(%.2f seconds)Time taken: "+ time2);
